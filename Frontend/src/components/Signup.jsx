      ...
      >
        ...
        <div className="p-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-3 text-white bg-clip-text text-transparent bg-gradient-to-r from-indigo-200 to-indigo-100">Create your account</h2>
            <p className="text-gray-400">Join the Echo community today</p>
          </div>
          ...
          <form className="space-y-5">
            ...
            <div className="group">
              ...
              <p className="mt-1.5 text-sm text-gray-400">Must be at least 8 characters</p>
            </div>
            
            <div className="pt-3">
              <button
                type="submit"
                className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-600 text-white font-medium rounded-xl py-3.5 px-4 transition-all duration-300 shadow-lg hover:shadow-indigo-600/20"
              >
